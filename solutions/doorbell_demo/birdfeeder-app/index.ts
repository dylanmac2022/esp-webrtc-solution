// Polyfill DOMException for React Native (required by livekit-client)
// Must run before ANY imports that transitively load livekit-client.
...
// Use require() instead of import to guarantee polyfill runs first
// (ES imports are hoisted above top-level code by the bundler)
